				...
				<div class="tab-pane active" id="tab-items">
					<table id="items-table" class="datatable table table-bordered table-hover">
						...
						<tfoot>
							...
							<th class="totalRemain">{{ number_format($totalRemainQuantity) }}</th>
							<th class="totalP">{{number_format($totalPrice)  }}</th>
							<th class="totalAmount">{{number_format( $invoice->amount) }}</th>
						</tfoot>
					</table>
				</div>
