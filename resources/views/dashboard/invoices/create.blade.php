			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-12">
					<div class="form-group">
						<label>العميل</label>
						<div class="input-group">
							<select class="form-control select2-single" id="bonus" onChange="calcbouns(this.options[this.selectedIndex].getAttribute('bonus'))" name="customer_id" required>
								<option> حدد  </option>
								@foreach ($customers as $customer)
									<option onClick="test()" bonus="{{$customer->bouns}}" value=
